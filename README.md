...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/dictpath-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12661&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/dictpath-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `dictpath` can be installed with:

```
conda install dictpath
```

It is possible to list all of the versions of `dictpath` available on your platform with:
